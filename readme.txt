...
To Extend Application :
 Step 1)
 	Create php file under api folder MYNewApp.php write class MYNewApp with method PostDataLog($Input,$Owner,$RName) as per requirent filename and class name must be same
